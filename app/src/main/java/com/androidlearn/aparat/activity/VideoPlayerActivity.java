    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.imgFavorite.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Videos videosObject = new Videos(videos.getId(), videos.getCatId(), videos.getTitle(),videos.getIcon()
                , videos.getCreator(),videos.getDescription() , videos.getLink(), videos.getView(), videos.getTime(),
                        videos.getSpecial());
